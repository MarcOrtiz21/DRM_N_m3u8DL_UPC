...
class BunnyVideoDRM:
    ...
    def download(self):
        ...
        url = [
            f"https://iframe.mediadelivery.net/{self.guid}/720p/video.drm?contextId={self.context_id}"
        ]
        ydl_opts = {
            "http_headers": {
...
if __name__ == "__main__":
    video = BunnyVideoDRM(
        ...
        referer="https://iframe.mediadelivery.net/embed/279029/f2a33811-ab64-439c-87a6-7bea3dbdf940?autoplay=true&loop=false&muted=false&preload=true&responsive=true&expires=1739922472&token=bbb0d3856185b8b09dff31c916fda03f2fbe66cb59ff6e01c8180307b1a75cfa",
        # paste your embed link
        embed_url="https://iframe.mediadelivery.net/embed/279029/f2a33811-ab64-439c-87a6-7bea3dbdf940?autoplay=true&loop=false&muted=false&preload=true&responsive=true&expires=1739922472&token=bbb0d3856185b8b09dff31c916fda03f2fbe66cb59ff6e01c8180307b1a75cfa",
